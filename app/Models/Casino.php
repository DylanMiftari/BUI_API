...
class Casino extends Model
{
    ...
    protected $fillable = [
        ...
        "diceVIPMaxBet",
        "nothingMultiplicator",
        "onePairMultiplicator",
        "twoPairMultiplicator",
        "threeOfAKindMultiplicator",
        "straightMultiplicator",
        "flushMultiplicator",
        "fullHouseMultiplicator",
        "fourOfAKindMultiplicator",
        "straightFlushMultiplicator",
        "royalFlushMultiplicator",
        "pokerMaxBet",
        "nothingVIPMultiplicator",
        "onePairVIPMultiplicator",
        "twoPairVIPMultiplicator",
        "threeOfAKindVIPMultiplicator",
        "straightVIPMultiplicator",
        "flushVIPMultiplicator",
        "fullHouseVIPMultiplicator",
        "fourOfAKindVIPMultiplicator",
        ...
        "blackJackVIPMaxBet",
        "roulette2StraigthUpMultiplicator",
        "roulette2SplitMultiplicator",
        "roulette2treetMultiplicator",
        "roulette2CornerMultiplicator",
        "roulette2SixLineMultiplicator",
        "roulette2ColumnMultiplicator",
        "roulette2DozenMultiplicator",
        "roulette2OddEvenMultiplicator",
        "roulette2RedBlackMultiplicator",
        "roulette2MiddleMultiplicator",
        "roulette2MaxBet",
        "roulette2VIPStraigthUpMultiplicator",
        "roulette2VIPSplitMultiplicator",
        "roulette2VIPtreetMultiplicator",
        "roulette2VIPCornerMultiplicator",
        "roulette2VIPSixLineMultiplicator",
        "roulette2VIPColumnMultiplicator",
        "roulette2VIPDozenMultiplicator",
        "roulette2VIPOddEvenMultiplicator",
        "roulette2VIPRedBlackMultiplicator",
        "roulette2VIPMiddleMultiplicator",
        "roulette2VIPMaxBet",
    ];
